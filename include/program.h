...
/**
 * @brief Evaluate all programs on the given dataset
 *
 * @param d_progs    Pointer to programs
 * @param n_rows     Number of rows in the input dataset
 * @param n_progs    Total number of programs being evaluated
 * @param data       Pointer to input dataset (in col-major format)
 ...
 * hyperparameters. It performs a batched computation for all programs in one
 * shot.
 *
 ...
 * @param y_pred    Device pointer to the predicted output (SIZE = n_samples *
 * n_progs)
 ...
 * @param score           Device pointer to fitness vals computed for all
 * programs
 * @param params          Training hyperparameters
 * @param n_rows          Number of rows in the input dataset
 * @param data            Device pointer to input dataset
...
/**
 * @brief Computes and sets the fitness scores for a single program on the given
 * dataset
 *
 * @param d_prog          Device pointer to program
...
/**
 * @brief Computes and sets the fitness scores for all programs on the given
 * dataset
 *
...
/**
 * @brief Returns precomputed fitness score of program,
...
/**
 * @brief Perform a 'hoisted' crossover mutation using the parent and donor
 * programs. The donor subtree selected is hoisted to ensure our constrains on
 * total depth
 *
 * @param prog    The input program
 ...
 * @param params  Training hyperparameters
 * @param rng     RNG to control subtree selection and temporary program
 * addition
 */
